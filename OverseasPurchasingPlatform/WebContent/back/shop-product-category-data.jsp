  ...
  <div class="container">
    ...
    <div class="row margin-bottom-40">
      ...
      <div class="col-md-9 col-sm-7">
        ...
        <!-- BEGIN PRODUCT LIST -->
        <h1>Category List</h1>       
        <div class="content-form-page margin-bottom-40 table-responsive">
          <div class="table-responsive">
            <br>
            <a href="ProductTypeServlet?task=queryBigType" class="btn btn-default margin-bottom-20">Create Category</a>
            <table border="0" class="table table-striped table-bordered table-hover table-condensed text-nowrap">
              <tr>
                <th>Edit</th>
                <th>Delete</th>
                <th>No.</th>
                <th>Category Name</th>
                <th>Big Category No.</th>
              </tr>
              <c:forEach var="type" items="${list }">
              <c:if test="${type.bigtypeid eq 0}">
              <tr>
                <td><a href="ProductTypeServlet?task=queryById&typeid=${type.typeid }">Edit</a></td>
                <td><a href="javascript:deleteProductType(${type.typeid })">Delete</a></td>
                <td>${type.typeid }</td>
                <td style="padding-left: 10px;">${type.typename }</td>
                <td>${type.bigtypeid }</td>
              </tr>
              <c:forEach var="small" items="${list }">
              <c:if test="${small.bigtypeid eq type.typeid }">
              <tr>
                <td><a href="ProductTypeServlet?task=queryById&typeid=${small.typeid }">Edit</a></td>
                <td><a href="javascript:deleteProductType(${small.typeid })">Delete</a></td>
                <td>${small.typeid }</td>
                <td style="padding-left: 60px;">${small.typename }</td>
                <td style="padding-left: 60px;">${small.bigtypeid }</td>
              </tr>
              </c:if>
              </c:forEach>
              </c:if>
...
<!-- BEGIN STEPS -->
    ...
    <script type="text/javascript">
        		function deleteProductType(typeid){
        			//alert(typeid);
        			var flag = window.confirm("Whether delete this category record?");
        			if(flag){
        				location.href = "ProductTypeServlet?task=delete&typeid="+typeid;
        			}
        		}
        </script>
</body>
