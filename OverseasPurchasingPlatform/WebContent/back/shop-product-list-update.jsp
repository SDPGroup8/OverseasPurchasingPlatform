...
<body class="ecommerce" onload="loadBigType();">
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="shop-index.html"><img src="assets/corporate/img/logos/logo-shop-blue.png" alt="Metronic Shop UI"></a>
        ...
        <div class="top-cart-block">
          <div class="top-cart-info">
            <a href="javascript:void(0);" class="top-cart-info-count">1 items</a>
            <a href="javascript:void(0);" class="top-cart-info-value">$100</a>
          </div>
  ...
  <div class="container">
    <ul class="breadcrumb">
        ...
        <li class="active">Product Detail Update</li>
    </ul>
    ...
    <div class="row margin-bottom-40">
     ...
     <!-- BEGIN CONTENT -->
				<div class="col-md-9 col-sm-7">
					<h1>Product Detail Update</h1>
					<div class="content-form-page margin-bottom-40">
						<form  action="ProductServlet?task=update&comid=${product.comid }" method="post" class="form-horizontal form-without-legend" enctype="multipart/form-data">
							<div class="form-group">
								<label class="col-lg-2 control-label" for="name">Name<span
									class="require">*</span></label>
								<div class="col-lg-8">
									<input type="text" name="comname" id="name" value="${product.comname }" class="form-control">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label" for="amount">Amount<span
									class="require">*</span></label>
								<div class="col-lg-8">
									<input type="text" name="amount" value="${product.quantity }" id="amount" class="form-control">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label" for="description">Description<span
									class="require">*</span></label>
								<div class="col-lg-8">
									<input type="text" name="description" value="${product.comdesc }" id="description" class="form-control">
								</div>
							</div>
							<div class="row">
								<div
