...
<!-- Body BEGIN -->
<body class="ecommerce" onload="loadBigType();">
	<script type="text/javascript">
		function loadBigType() {

			var http = new XMLHttpRequest();
			
			http.open("GET", "ProductTypeServlet?task=loadBigType", true);
			http.send();
			...
			http.onreadystatechange = function() {
				if (http.readyState == '4' && http.status == '200') {
					...
					var bigtype = document.getElementById("bigtypeid");
		...
		function loadSmallType(id) {
			...
			http.open("GET","ProductTypeServlet?task=loadSmallType&typeid=" + id,
					true);
			http.send();
			...
			http.onreadystatechange = function() {
				if (http.readyState == '4' && http.status == '200') {
					...
					var types = eval(http.responseText);
					var small = document.getElementById("smalltypeid");
					small.length = 1;
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 additional-shop-info">
					<ul class="list-unstyled list-inline">
						...
						<!-- BEGIN CURRENCIES -->
						<li class="shop-currencies"><a href="javascript:void(0);"
							class="current">$ NZD</a></li>
						<!-- END CURRENCIES -->
						<!-- BEGIN LANGS -->
						<li class="langs-block"><a href="javascript:void(0);"
							class="current">English </a></li>
						<!-- END LANGS -->
					</ul>
				</div>
			...
			<div class="header-navigation">
				<ul>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" data-target="#" href="javascript:;">Baby
							&amp; Child Care</a>
						<ul class="dropdown-menu">
							<li><a href="shop-for-baby.html">For Baby &amp; Child</a></li>
							<li><a href="shop-for-mum.html">For Mum</a></li>
							<li><a href="shop-accessories.html">Accessories</a></li>
						</ul></li>

					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" data-target="#" href="javascript:;">Natural
							Health</a>
						<ul class="dropdown-menu">
							<li><a href="shop-bone-joint-health.html">Bone &amp;
									Joint Support</a></li>
							...
							<li><a href="shop-diet-weight-loss.html">Diet &amp;
									Weight Loss</a></li>
							<li><a href="shop-multivitamin-minerals.html">MultiVitamin
									&amp; Minerals</a></li>
						</ul></li>

					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" data-target="#" href="javascript:;">Beauty</a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" data-target="#" href="javascript:;">Food</a>
						<ul class="dropdown-menu">
			...
			<div class="row margin-bottom-40">
				...
				<div class="col-md-9 col-sm-7">
					...
					<div class="content-form-page margin-bottom-40">
						<form  action="ProductServlet?task=add" method="post" class="form-horizontal form-without-legend" enctype="multipart/form-data">
							<div class="form-group">
								<label class="col-lg-2 control-label" for="name">Name<span
									class="require">*</span></label>
								<div class="col-lg-8">
									<input type="text" name="comname" id="name" class="form-control">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label" for="price">Price<span
									class="require">*</span></label>
								<div class="col-lg-8">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label" for="amount">Amount<span
									class="require">*</span></label>
								<div class="col-lg-8">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label" for="image">Upload
							...
							<div class="row">
								<div
									...
									<a href="ProductServlet">Back to Listing</a>
								</div>
							</div>
						</form>
					</div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 pre-footer-col">
					...
					<ul class="list-unstyled">
						<li><i class="fa fa-angle-right"></i> <a href="javascript:;">My
								account</a></li>
				...
				<div class="col-md-3 col-sm-6 pre-footer-col">
					...
					<address class="margin-bottom-40">
						35, Lorem Lis Street, Park Ave<br> Auckland, New Zealand<br>
						Phone: 300 323 3456<br> Email: <a
	...
	<div class="footer">
		<div class="container">
			<div class="row">
				<!-- BEGIN COPYRIGHT -->
				<div class="col-md-4 col-sm-4 padding-top-10">2017 © Group 8.
