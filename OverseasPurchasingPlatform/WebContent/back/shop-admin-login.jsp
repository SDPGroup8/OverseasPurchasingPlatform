    ...
    <div class="row margin-bottom-40">
      ...
      <div class="col-md-9 col-sm-7">
        ...
        <div class="content-form-page margin-bottom-40">
          <form role="form" action="BackLoginServlet" method="post" class="form-horizontal form-without-legend">                        
            <div class="form-group">
              <label class="col-lg-2 control-label" for="email-login">Admin Name<span class="require">*</span></label>
              <div class="col-lg-8">
                <input type="text" name="adminName" id="email-login" class="form-control">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-2 control-label" for="password-login">Password<span class="require">*</span></label>
              <div class="col-lg-8">
                <input type="password" name="apassword" id="password-login" class="form-control">
              </div>
            </div>
            <div class="row">
              <div class="col-lg-8 col-md-offset-2 padding-left-0 padding-top-20">
                <button class="btn btn-primary" type="submit">Login</button>
                <input type="checkbox" name="rememberPassword" value="rememberPassword"> Remember Password
              	<label>
