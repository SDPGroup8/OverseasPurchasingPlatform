    ...
    <div class="row margin-bottom-40">
      ...
      <div class="col-md-9 col-sm-7">
        ...
        <div class="content-form-page margin-bottom-40 table-responsive">
            ...
            <form action="ProductServlet" method="post" id="myForm" >
			<input type="hidden" name="currentPage"
			 id="currentPage" value="${page.currentPage }">
			<input type="hidden" name="pageSize" 
			id="pageSize" value="${page.pageSize }">
		</form>
            <br>
            <a href="shop-product-list-create.jsp" class="btn btn-default margin-bottom-20">Create Product</a>
            <table border="0" class="table table-striped table-bordered table-hover table-condensed text-nowrap">
              ...
              <tr>
                <td><a href="ProductServlet?task=queryById&comid=${product.comid }">Edit</a></td>
                <td><a href="javascript:deleteProduct(${product.comid })">Delete</a></td>
                <td>${product.comid }</td>
                <td>${product.comname }</td>
                <td>${product.smalltypeid }</td>
                <td>${product.quantity }</td>
                <td>${product.price}</td>
                <th><img src="1.jpg" alt="Image"></th>               
                <td>${product.comdesc } </td>
              </tr>
              </c:forEach>
            </table>
          </div>
...
<!-- BEGIN STEPS -->
    ...
    <script type="text/javascript">
		...
		function deleteProduct(comid){
			//alert(typeid);
			var flag = window.confirm("Whether delete this product record?");
			if(flag){
				location.href = "ProductServlet?task=delete&comid="+comid;
			}
		}
    </script>
