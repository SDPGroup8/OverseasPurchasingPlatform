...
<div>
		...
		总共有<font style="color:red;font-weight: bold;">${page.totalPage }</font>页
		到第
			<select style="width: 60px;" onchange="changeCurrentPage(this.value);">
				<c:forEach var="i" begin="1" end="${page.totalPage }">
				<option value="${i }" 
					${i eq page.currentPage?'selected="selected"':'' }>
					${i }
				</option>
				</c:forEach>
			</select>
